...
**Frontend:**  
`React.js` `Next.js` `TypeScript` `JavaScript (ES6+)` `HTML5` `CSS3` `Tailwind CSS` `Bootstrap 5`
...
#### 🛒 [TechCart — Full Stack E-Commerce Platform](https://github.com/Pravin671231/TechCart)
